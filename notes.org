...
First proof -> general is impossible
Second proof -> assumption about contexts allows a formulation.
Third statement -> using leave-one-out is necessary
...
1. Most involve some sort of IPW to reweight.
2. Some involve "outcome modeling" - like Rudolph 2017, missing Dahabreh 2020, and Yang 2019
